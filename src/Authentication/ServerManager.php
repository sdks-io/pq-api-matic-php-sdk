...
use PayQuickerSDKLib\ConfigurationDefaults;

/**
 * Utility class for OAuth 2 authorization and token management
 */
class ServerManager extends CoreAuth implements ServerCredentials
{
    /**
    ...
    /**
     * OAuthScopeServer value for oAuthScopes.
     */
    ...
    {
        return $this->config['server-ClockSkew'] ?? ConfigurationDefaults::SERVER_CLOCK_SKEW;
    }
    ...
    public function fetchToken(?array $additionalParams = null): OAuthToken
    {
        ...
        $oAuthToken = $this->oAuthApi->requestTokenServer(
    ...
    private function getTokenFromProvider(): ?OAuthToken
    {
        ...
        $provider = $this->config['server-TokenProvider'];
        ...
        $updateCallback = $this->config['server-OnTokenUpdate'];
