...
/**
 * [Validator type](#/rest/models/structures/electronic-wallet-requirement-validator) that for the
 * required electronic wallet information.
 */
class ElectronicWalletRequirementValidator implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the ElectronicWalletRequirementValidator object to a human-readable string representation.
     *
     * @return string The string representation of the ElectronicWalletRequirementValidator object.
     */
