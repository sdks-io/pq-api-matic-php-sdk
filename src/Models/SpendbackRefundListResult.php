...
class SpendbackRefundListResult implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the SpendbackRefundListResult object to a human-readable string representation.
     *
     * @return string The string representation of the SpendbackRefundListResult object.
     */
