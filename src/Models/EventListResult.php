...
class EventListResult implements \JsonSerializable
{
    /**
     * @var EventObject[]
     */
    ...
    /**
     * Converts the EventListResult object to a human-readable string representation.
     *
     * @return string The string representation of the EventListResult object.
     */
