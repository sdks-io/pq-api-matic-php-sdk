...
class PrepaidCardPinResult implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the PrepaidCardPinResult object to a human-readable string representation.
     *
     * @return string The string representation of the PrepaidCardPinResult object.
     */
