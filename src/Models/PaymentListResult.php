...
class PaymentListResult implements \JsonSerializable
{
    /**
     * @var PaymentObject[]
     */
    ...
    /**
     * Converts the PaymentListResult object to a human-readable string representation.
     *
     * @return string The string representation of the PaymentListResult object.
     */
