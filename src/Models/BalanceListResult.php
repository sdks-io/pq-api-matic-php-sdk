...
class BalanceListResult implements \JsonSerializable
{
    /**
     * @var BalanceObject[]
     */
    ...
    /**
     * Converts the BalanceListResult object to a human-readable string representation.
     *
     * @return string The string representation of the BalanceListResult object.
     */
