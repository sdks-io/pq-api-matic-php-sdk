...
class SpendbackRefundResult implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the SpendbackRefundResult object to a human-readable string representation.
     *
     * @return string The string representation of the SpendbackRefundResult object.
     */
