...
class PrepaidCardReplacementReasons
{
    ...
    private const _ALL_VALUES = [self::COMPROMISED, self::DAMAGED, self::EXPIRED, self::LOST, self::STOLEN];
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for PrepaidCardReplacementReasons.");
    }
}
