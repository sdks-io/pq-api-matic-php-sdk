...
class SpendbackResult implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the SpendbackResult object to a human-readable string representation.
     *
     * @return string The string representation of the SpendbackResult object.
     */
