...
/**
 * Builder for model CreateSpendbackRefundQuote
 *
 * @see CreateSpendbackRefundQuote
 */
class CreateSpendbackRefundQuoteBuilder
{
    /**
     * @var CreateSpendbackRefundQuote
     */
    private $instance;

    private function __construct(CreateSpendbackRefundQuote $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Create Spendback Refund Quote Builder object.
     */
    public static function init(): self
    {
        return new self(new CreateSpendbackRefundQuote());
    }
    ...
    /**
     * Initializes a new Create Spendback Refund Quote object.
     */
    public function build(): CreateSpendbackRefundQuote
    {
