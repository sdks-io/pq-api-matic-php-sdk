...
/**
 * Builder for model TransferObject
 *
 * @see TransferObject
 */
class TransferObjectBuilder
{
    ...
    private function __construct(TransferObject $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Transfer Object Builder object.
     */
    public static function init(): self
    {
        return new self(new TransferObject());
    }
    ...
    /**
     * Initializes a new Transfer Object object.
     */
    public function build(): TransferObject
    {
