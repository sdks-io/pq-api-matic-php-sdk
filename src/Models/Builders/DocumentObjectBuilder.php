...
/**
 * Builder for model DocumentObject
 *
 * @see DocumentObject
 */
class DocumentObjectBuilder
{
    ...
    private function __construct(DocumentObject $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Document Object Builder object.
     *
    ...
    {
        return new self(new DocumentObject($createDate, $token, $links));
    }
    ...
    /**
     * Initializes a new Document Object object.
     */
    public function build(): DocumentObject
    {
