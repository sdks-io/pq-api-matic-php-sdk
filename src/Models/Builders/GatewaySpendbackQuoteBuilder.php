...
use PayQuickerSDKLib\Models\GatewaySpendbackQuote;

/**
 * Builder for model GatewaySpendbackQuote
 *
 * @see GatewaySpendbackQuote
 */
class GatewaySpendbackQuoteBuilder
{
    /**
     * @var GatewaySpendbackQuote
     */
    private $instance;

    private function __construct(GatewaySpendbackQuote $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Gateway Spendback Quote Builder object.
     */
    public static function init(): self
    {
        return new self(new GatewaySpendbackQuote());
    }
    ...
    /**
     * Initializes a new Gateway Spendback Quote object.
     */
    public function build(): GatewaySpendbackQuote
    {
