...
/**
 * Builder for model SpendbackRefundObject
 *
 * @see SpendbackRefundObject
 */
class SpendbackRefundObjectBuilder
{
    /**
     * @var SpendbackRefundObject
     */
    private $instance;

    private function __construct(SpendbackRefundObject $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Spendback Refund Object Builder object.
     */
    public static function init(): self
    {
        return new self(new SpendbackRefundObject());
    }
    ...
    /**
     * Initializes a new Spendback Refund Object object.
     */
    public function build(): SpendbackRefundObject
    {
