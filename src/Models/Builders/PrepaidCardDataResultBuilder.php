...
/**
 * Builder for model PrepaidCardDataResult
 *
 * @see PrepaidCardDataResult
 */
class PrepaidCardDataResultBuilder
{
    /**
     * @var PrepaidCardDataResult
     */
    private $instance;

    private function __construct(PrepaidCardDataResult $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Prepaid Card Data Result Builder object.
     */
    public static function init(): self
    {
        return new self(new PrepaidCardDataResult());
    }
    ...
    /**
     * Initializes a new Prepaid Card Data Result object.
     */
    public function build(): PrepaidCardDataResult
    {
