...
/**
 * Builder for model CreateInvitation
 *
 * @see CreateInvitation
 */
class CreateInvitationBuilder
{
    /**
    ...
    private function __construct(CreateInvitation $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Create Invitation Builder object.
     */
    public static function init(): self
    {
        return new self(new CreateInvitation());
    }
    ...
    /**
     * Initializes a new Create Invitation object.
     */
    public function build(): CreateInvitation
    {
