...
/**
 * Builder for model PaymentJobObject
 *
 * @see PaymentJobObject
 */
class PaymentJobObjectBuilder
{
    /**
     * @var PaymentJobObject
     */
    private $instance;

    private function __construct(PaymentJobObject $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Payment Job Object Builder object.
     */
    public static function init(): self
    {
        return new self(new PaymentJobObject());
    }
    ...
    /**
     * Initializes a new Payment Job Object object.
     */
    public function build(): PaymentJobObject
    {
