...
use PayQuickerSDKLib\Models\SpendbackQuoteAcceptResult;
use PayQuickerSDKLib\Models\SpendbackRefundObject;

/**
 * Builder for model SpendbackQuoteAcceptResult
 *
 * @see SpendbackQuoteAcceptResult
 */
class SpendbackQuoteAcceptResultBuilder
{
    /**
     * @var SpendbackQuoteAcceptResult
     */
    private $instance;

    private function __construct(SpendbackQuoteAcceptResult $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Spendback Quote Accept Result Builder object.
     */
    public static function init(): self
    {
        return new self(new SpendbackQuoteAcceptResult());
    }
    ...
    /**
     * Initializes a new Spendback Quote Accept Result object.
     */
    public function build(): SpendbackQuoteAcceptResult
    {
