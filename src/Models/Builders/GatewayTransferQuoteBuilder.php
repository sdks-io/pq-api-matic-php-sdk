...
use PayQuickerSDKLib\Models\GatewayTransferQuote;

/**
 * Builder for model GatewayTransferQuote
 *
 * @see GatewayTransferQuote
 */
class GatewayTransferQuoteBuilder
{
    /**
     * @var GatewayTransferQuote
     */
    private $instance;

    private function __construct(GatewayTransferQuote $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Gateway Transfer Quote Builder object.
     */
    public static function init(): self
    {
        return new self(new GatewayTransferQuote());
    }
    ...
    /**
     * Initializes a new Gateway Transfer Quote object.
     */
    public function build(): GatewayTransferQuote
    {
