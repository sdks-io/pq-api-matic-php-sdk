...
/**
 * Builder for model InvitationObject
 *
 * @see InvitationObject
 */
class InvitationObjectBuilder
{
    /**
    ...
    private function __construct(InvitationObject $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Invitation Object Builder object.
     */
    public static function init(): self
    {
        return new self(new InvitationObject());
    }
    ...
    /**
     * Initializes a new Invitation Object object.
     */
    public function build(): InvitationObject
    {
