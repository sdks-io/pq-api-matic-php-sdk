...
/**
 * Builder for model InvitationResult
 *
 * @see InvitationResult
 */
class InvitationResultBuilder
{
    /**
    ...
    private function __construct(InvitationResult $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Invitation Result Builder object.
     */
    public static function init(): self
    {
        return new self(new InvitationResult());
    }
    ...
    /**
     * Initializes a new Invitation Result object.
     */
    public function build(): InvitationResult
    {
