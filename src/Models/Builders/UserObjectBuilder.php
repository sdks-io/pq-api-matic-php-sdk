...
class UserObjectBuilder
{
    ...
    private function __construct(UserObject $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new User Object Builder object.
     */
    public static function init(): self
    {
        return new self(new UserObject());
    }
    ...
    /**
     * Initializes a new User Object object.
     */
