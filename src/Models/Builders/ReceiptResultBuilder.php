...
/**
 * Builder for model ReceiptResult
 *
 * @see ReceiptResult
 */
class ReceiptResultBuilder
{
    /**
     * @var ReceiptResult
     */
    ...
    private function __construct(ReceiptResult $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Receipt Result Builder object.
     */
    public static function init(): self
    {
        return new self(new ReceiptResult());
    }
    ...
    /**
     * Initializes a new Receipt Result object.
     */
    public function build(): ReceiptResult
    {
