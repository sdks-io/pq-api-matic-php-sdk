...
/**
 * Builder for model CreateOrUpdateUser
 *
 * @see CreateOrUpdateUser
 */
class CreateOrUpdateUserBuilder
{
    /**
    ...
    private function __construct(CreateOrUpdateUser $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Create Or Update User Builder object.
     */
    public static function init(): self
    {
        return new self(new CreateOrUpdateUser());
    }
    ...
    /**
     * Sets premise Number field.
     *
     * @param string|null $value
     */
    public function premiseNumber(?string $value): self
    {
        $this->instance->setPremiseNumber($value);
        return $this;
    }
    ...
    /**
     * Sets primary User Token field.
     *
     * @param string|null $value
     */
    public function primaryUserToken(?string $value): self
    {
        $this->instance->setPrimaryUserToken($value);
        return $this;
    }
    ...
    /**
     * Initializes a new Create Or Update User object.
     */
    public function build(): CreateOrUpdateUser
    {
