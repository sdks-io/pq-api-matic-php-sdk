...
/**
 * Builder for model SpendbackResult
 *
 * @see SpendbackResult
 */
class SpendbackResultBuilder
{
    /**
     * @var SpendbackResult
     */
    ...
    private function __construct(SpendbackResult $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Spendback Result Builder object.
     */
    public static function init(): self
    {
        return new self(new SpendbackResult());
    }
    ...
    /**
     * Initializes a new Spendback Result object.
     */
    public function build(): SpendbackResult
    {
