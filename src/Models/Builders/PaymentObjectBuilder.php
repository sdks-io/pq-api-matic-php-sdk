...
/**
 * Builder for model PaymentObject
 *
 * @see PaymentObject
 */
class PaymentObjectBuilder
{
    /**
     * @var PaymentObject
     */
    ...
    private function __construct(PaymentObject $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Payment Object Builder object.
     */
    public static function init(): self
    {
        return new self(new PaymentObject());
    }
    ...
    /**
     * Initializes a new Payment Object object.
     */
    public function build(): PaymentObject
    {
