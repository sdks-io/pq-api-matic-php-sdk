...
class ReceiptObject implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the ReceiptObject object to a human-readable string representation.
     *
     * @return string The string representation of the ReceiptObject object.
     */
