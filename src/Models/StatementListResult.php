...
class StatementListResult implements \JsonSerializable
{
    /**
     * @var StatementObject[]
     */
    ...
    /**
     * Converts the StatementListResult object to a human-readable string representation.
     *
     * @return string The string representation of the StatementListResult object.
     */
