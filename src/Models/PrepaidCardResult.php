...
class PrepaidCardResult implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the PrepaidCardResult object to a human-readable string representation.
     *
     * @return string The string representation of the PrepaidCardResult object.
     */
