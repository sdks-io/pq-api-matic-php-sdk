...
class ElectronicWalletListResult implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the ElectronicWalletListResult object to a human-readable string representation.
     *
     * @return string The string representation of the ElectronicWalletListResult object.
     */
