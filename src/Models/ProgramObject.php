...
class ProgramObject implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the ProgramObject object to a human-readable string representation.
     *
     * @return string The string representation of the ProgramObject object.
     */
