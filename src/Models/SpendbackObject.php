...
class SpendbackObject implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the SpendbackObject object to a human-readable string representation.
     *
     * @return string The string representation of the SpendbackObject object.
     */
