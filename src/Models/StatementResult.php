...
class StatementResult implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the StatementResult object to a human-readable string representation.
     *
     * @return string The string representation of the StatementResult object.
     */
