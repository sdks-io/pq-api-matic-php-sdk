...
class PrepaidCardAuthorizations
{
    ...
    public const UNSETTLED_AUTHORIZATION = 'UNSETTLED_AUTHORIZATION';

    public const FEE_REBATE = 'FEE_REBATE';

    public const EFT_FX_MARGIN = 'EFT_FX_MARGIN';
    ...
    public static function checkValue($value)
    {
        ...
        throw new Exception("$value is invalid for PrepaidCardAuthorizations.");
    }
}
