...
class IdvCheckObject implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the IdvCheckObject object to a human-readable string representation.
     *
     * @return string The string representation of the IdvCheckObject object.
     */
