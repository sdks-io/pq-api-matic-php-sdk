...
class AgreementListResultJson implements \JsonSerializable
{
    /**
     * @var AgreementObject[]
     */
    ...
    /**
     * Converts the AgreementListResultJson object to a human-readable string representation.
     *
     * @return string The string representation of the AgreementListResultJson object.
     */
