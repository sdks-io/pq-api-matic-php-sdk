...
/**
 * Classifies the [legend format](#/rest/models/structures/bank-account-requirement-format-legend) of
...
class BankAccountRequirementFormatLegend implements \JsonSerializable
{
    ...
    /**
     * Converts the BankAccountRequirementFormatLegend object to a human-readable string representation.
     *
     * @return string The string representation of the BankAccountRequirementFormatLegend object.
     */
