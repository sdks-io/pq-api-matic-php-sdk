...
class UserListResult implements \JsonSerializable
{
    /**
     * @var UserObject[]
     */
    ...
    /**
     * Converts the UserListResult object to a human-readable string representation.
     *
     * @return string The string representation of the UserListResult object.
     */
