...
class AgreementObject implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the AgreementObject object to a human-readable string representation.
     *
     * @return string The string representation of the AgreementObject object.
     */
