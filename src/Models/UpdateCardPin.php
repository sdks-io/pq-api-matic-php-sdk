...
class UpdateCardPin implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the UpdateCardPin object to a human-readable string representation.
     *
     * @return string The string representation of the UpdateCardPin object.
     */
