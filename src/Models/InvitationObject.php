 ...
 */
class InvitationObject implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the InvitationObject object to a human-readable string representation.
     *
     * @return string The string representation of the InvitationObject object.
     */
