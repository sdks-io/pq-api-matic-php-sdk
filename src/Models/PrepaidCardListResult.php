...
class PrepaidCardListResult implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the PrepaidCardListResult object to a human-readable string representation.
     *
     * @return string The string representation of the PrepaidCardListResult object.
     */
