...
class WebhookSubscriptionListResult implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the WebhookSubscriptionListResult object to a human-readable string representation.
     *
     * @return string The string representation of the WebhookSubscriptionListResult object.
     */
