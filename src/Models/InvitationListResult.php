...
class InvitationListResult implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the InvitationListResult object to a human-readable string representation.
     *
     * @return string The string representation of the InvitationListResult object.
     */
