...
class CreateInvitation implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the CreateInvitation object to a human-readable string representation.
     *
     * @return string The string representation of the CreateInvitation object.
     */
