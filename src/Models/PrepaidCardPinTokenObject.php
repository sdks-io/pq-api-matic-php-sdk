...
class PrepaidCardPinTokenObject implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the PrepaidCardPinTokenObject object to a human-readable string representation.
     *
     * @return string The string representation of the PrepaidCardPinTokenObject object.
     */
