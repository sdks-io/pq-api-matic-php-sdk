...
class BankAccountListResult implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the BankAccountListResult object to a human-readable string representation.
     *
     * @return string The string representation of the BankAccountListResult object.
     */
