 ...
 * transfer object
 */
class TransferObject implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the TransferObject object to a human-readable string representation.
     *
     * @return string The string representation of the TransferObject object.
     */
