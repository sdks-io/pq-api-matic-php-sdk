...
class PaymentJobResult implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the PaymentJobResult object to a human-readable string representation.
     *
     * @return string The string representation of the PaymentJobResult object.
     */
