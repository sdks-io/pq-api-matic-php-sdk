...
class BankAccountResult implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the BankAccountResult object to a human-readable string representation.
     *
     * @return string The string representation of the BankAccountResult object.
     */
