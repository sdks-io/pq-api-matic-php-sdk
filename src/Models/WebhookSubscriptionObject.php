 ...
 */
class WebhookSubscriptionObject implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the WebhookSubscriptionObject object to a human-readable string representation.
     *
     * @return string The string representation of the WebhookSubscriptionObject object.
     */
