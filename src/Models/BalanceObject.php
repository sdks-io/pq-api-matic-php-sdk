...
class BalanceObject implements \JsonSerializable
{
    /**
     * @var float
     */
    ...
    /**
     * Converts the BalanceObject object to a human-readable string representation.
     *
     * @return string The string representation of the BalanceObject object.
     */
