...
class PaymentJobListResult implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the PaymentJobListResult object to a human-readable string representation.
     *
     * @return string The string representation of the PaymentJobListResult object.
     */
