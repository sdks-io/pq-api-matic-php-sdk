 ...
 * TODO
 */
class GatewayPaymentQuote implements \JsonSerializable
{
    /**
     * @var float|null
     */
    ...
    /**
     * Converts the GatewayPaymentQuote object to a human-readable string representation.
     *
     * @return string The string representation of the GatewayPaymentQuote object.
     */
