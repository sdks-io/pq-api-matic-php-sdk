 ...
 */
class ElectronicWalletObject implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the ElectronicWalletObject object to a human-readable string representation.
     *
     * @return string The string representation of the ElectronicWalletObject object.
     */
