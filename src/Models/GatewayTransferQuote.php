 ...
 * TODO
 */
class GatewayTransferQuote implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the GatewayTransferQuote object to a human-readable string representation.
     *
     * @return string The string representation of the GatewayTransferQuote object.
     */
