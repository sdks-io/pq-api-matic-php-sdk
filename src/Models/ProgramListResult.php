...
class ProgramListResult implements \JsonSerializable
{
    /**
     * @var ProgramObject[]
     */
    ...
    /**
     * Converts the ProgramListResult object to a human-readable string representation.
     *
     * @return string The string representation of the ProgramListResult object.
     */
