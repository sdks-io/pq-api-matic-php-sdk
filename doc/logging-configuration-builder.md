...
The following example uses `Monolog\Logger` implementation of `Psr\Log\LoggerInterface` for PayQuickerSDKClient initialization.
...
$logger = new Logger('PayQuickerSDK');
