...
|  --- | --- | --- | --- | --- | --- |
| `type` | [`string(ElectronicWalletTypes)`](../../doc/models/electronic-wallet-types.md) | Required | Name of the electronic wallet | getType(): string | setType(string type): void |
...
| `electronicWalletCurrency` | [`string(Currencies)`](../../doc/models/currencies.md) | Required | [Currency code type](#/rest/models/structures/country) for the object<br><br>**Default**: `Currencies::USD` | getElectronicWalletCurrency(): string | setElectronicWalletCurrency(string electronicWalletCurrency): void |
