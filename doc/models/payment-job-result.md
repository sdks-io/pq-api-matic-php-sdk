...
| `fileToken` | `?string` | Optional | [Token](#/rest/models/structures/token) representing the document<br><br>**Default**: `'docu-2053aaad-c1a5-45e2-a2da-f71287f32800'`<br><br>**Constraints**: *Minimum Length*: `41`, *Maximum Length*: `41`, *Pattern*: `^docu-[0-9A-Fa-f]{8}(?:-[0-9A-Fa-f]{4}){3}-[0-9A-Fa-f]{12}$` | getFileToken(): ?string | setFileToken(?string fileToken): void |
...
| `type` | [`?string(JobTypes)`](../../doc/models/job-types.md) | Optional | Job Types | getType(): ?string | setType(?string type): void |
| `status` | [`?string(JobStatusTypes)`](../../doc/models/job-status-types.md) | Optional | Job Status Types | getStatus(): ?string | setStatus(?string status): void |
| `items` | [`?(PaymentObject[])`](../../doc/models/payment-object.md) | Optional | - | getItems(): ?array | setItems(?array items): void |
