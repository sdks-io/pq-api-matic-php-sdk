...
| `legend` | [`?(ElectronicWalletRequirementFormatLegend[])`](../../doc/models/electronic-wallet-requirement-format-legend.md) | Optional | - | getLegend(): ?array | setLegend(?array legend): void |
