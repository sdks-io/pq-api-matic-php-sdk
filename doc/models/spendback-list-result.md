...
|  --- | --- | --- | --- | --- | --- |
| `payload` | [`SpendbackObject[]`](../../doc/models/spendback-object.md) | Required | **Constraints**: *Minimum Items*: `1`, *Unique Items Required* | getPayload(): array | setPayload(array payload): void |
